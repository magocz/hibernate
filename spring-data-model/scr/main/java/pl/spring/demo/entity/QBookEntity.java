...
public class QBookEntity extends EntityPathBase<BookEntity> {
    ...
    private static final long serialVersionUID = 1556753531;

    private static final PathInits INITS = PathInits.DIRECT;

    public static final QBookEntity bookEntity = new QBookEntity("bookEntity");

    public final SetPath<AuthorEntity, QAuthorEntity> authors = this.<AuthorEntity, QAuthorEntity>createSet("authors", AuthorEntity.class, QAuthorEntity.class, PathInits.DIRECT);
